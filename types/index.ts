...
/** یک نظر از کارفرما — در بخش «نظرات کارفرمایان» صفحه اصلی نمایش داده می‌شود. */
export type Testimonial = {
  id: string;
  /** متن نظر، بدون گیومه؛ گیومه در لایه‌ی UI اضافه می‌شود. */
  quote: string;
  name: string;
  /** سمت و نام مجموعه — مثلاً «مدیر محصول دوفیکسو». */
  role: string;
  /**
   * مسیر تصویر در `public/images/testimonials`.
   * تا وقتی خالی باشد، آواتار برندشده با حرف اول نام نمایش داده می‌شود؛
   * ابعاد در هر دو حالت یکسان است و جایگزینی Layout Shift ایجاد نمی‌کند.
   */
  image?: string;
  /** ظاهر کارت — مستقیماً به variant کامپوننت Card نگاشت می‌شود. */
  variant: "solid" | "brand" | "invert";
  /** نظرهای شاخص متن بلندتری دارند و بافت گرید پس‌زمینه می‌گیرند. */
  featured?: boolean;
};
